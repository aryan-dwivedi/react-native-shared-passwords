  ...
  describe('requestPasswordAutoFill', () => {
    ...
    it('should include helpful message about Expo Go', async () => {
      try {
        ...
        expect((error as Error).message).toContain('Expo Go');
        expect((error as Error).message).toContain('Password autofill');
      }
    });
  });
  ...
  describe('savePassword', () => {
    ...
    it('should include helpful message about development build', async () => {
      try {
        ...
        expect((error as Error).message).toContain('Password saving');
        expect((error as Error).message).toContain('development build');
      }
    });
  });
  ...
  describe('deleteCredential', () => {
    ...
    it('should include helpful message', async () => {
      try {
        ...
        expect((error as Error).message).toContain('Credential deletion');
      }
    });
  });
  ...
  describe('createPasskey', () => {
    ...
    it('should include helpful message about passkey creation', async () => {
      try {
        ...
        expect((error as Error).message).toContain('Passkey creation');
        expect((error as Error).message).toContain('Expo Go');
      }
    });
  });
  ...
  describe('authenticateWithPasskey', () => {
    ...
    it('should include helpful message about passkey authentication', async () => {
      try {
        ...
        expect((error as Error).message).toContain('Passkey authentication');
      }
    });
  });
...
describe('ExpoGoFallback error messages', () => {
  it('should provide instructions to create development build', async () => {
    try {
      ...
      expect((error as Error).message).toMatch(/npx expo run:ios|npx expo run:android/);
    }
  });
  ...
  it('should mention EAS Build as an option', async () => {
    try {
      ...
      expect((error as Error).message).toContain('EAS Build');
    }
  });
});
