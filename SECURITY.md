...
We take the security of `react-native-shared-credentials` seriously. If you discover a security vulnerability, please report it responsibly.

### Private Vulnerability Reporting

**Preferred:** Use [GitHub's private vulnerability reporting](https://github.com/aryan-dwivedi/react-native-shared-credentials/security/advisories/new) to submit a report directly through GitHub. This ensures the issue is handled confidentially.
...
- The `react-native-shared-credentials` npm package
