# Contributing to react-native-shared-credentials
...
1. Clone the repository:
   ```bash
   git clone https://github.com/aryan-dwivedi/react-native-shared-credentials.git
   cd react-native-shared-credentials
   ```
